...
import json
from webapp.utils.utils import get_by_country_merged

def geo_analysis(final_df):
...
def global_timeseries(timeseries_final):
...
def per_country_time_series(total_confirmed, total_death, total_recovered, country_name):
